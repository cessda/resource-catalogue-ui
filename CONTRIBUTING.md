# Contributing to [Resource Catalogue UI]
...
- Provide a clear description of the problem, the environment, and steps to
reproduce it.
...
5. Submit a pull request (PR) with a clear description of what you’ve done and
    why.
